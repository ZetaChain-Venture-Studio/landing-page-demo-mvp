      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-6 pt-32 pb-20 md:pt-40 md:pb-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            {/* Waitlist form */}
            <div className="mb-20" id="waitlist">
              <WaitlistForm />
            </div>

            {/* Feature hints */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto mb-4" id="features">
        ...
        {/* Demo section */}
        <div className="border-t border-[#e7e5e4]" id="how-it-works">
